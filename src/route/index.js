          ...
          projects: [
            {
              ...
              about:
                'Airbnb competitor. High-load application for searching appartments',
              stacks: [
                {
                  name: 'React.js',
                },
              ...
              awards: [
                ...
                {
                  name: 'Preparing SEO optimized pages. The automated process for getting data for the app from documents.',
                },
              ],
              awardAmount: 22,
            },
